...
import { Briefcase, Users, Plus, Inbox, Edit, Trash2, Eye } from 'lucide-react';
...
export default function EmployerDashboard() {
  ...
  const getCompanyName = () => {
    if (user.role === 'employer' && 'companyName' in user.profile)
      return (user.profile as { companyName?: string }).companyName || 'Your Company';
    return 'Your Company';
  };
          ...
          <div className="bg-white dark:bg-[#111827] rounded-xl border border-[#E2E8F0] dark:border-[#1F2937]">
            ...
            {loading ? (
              ...
              <EmptyState
                ...
                description="Start attracting top talent by posting your first job opening."
                action={
                  <Button size="sm" asChild>
                    <Link href="/dashboard/employer/jobs/new">
                      <Plus className="h-4 w-4" aria-hidden="true" />
