...
export function Footer({ className }: FooterProps) {
  ...
  return (
    <footer className={cn(
      'bg-secondary-50 border-t border-secondary-200 dark:bg-secondary-900 dark:border-secondary-800',
      className
    )}>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="text-secondary-500 hover:text-primary-600 transition-colors dark:text-secondary-400 dark:hover:text-primary-400"
                aria-label="Twitter"
              >
        ...
        <div className="mt-12 pt-8 border-t border-secondary-200 dark:border-secondary-800">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6">
              <Link
                href={ROUTES.PRIVACY}
                className="text-sm text-secondary-600 hover:text-primary-600 transition-colors dark:text-secondary-400 dark:hover:text-primary-400"
              >
                Privacy
              </Link>
              <Link
